...
import profileImage from '/Users/achyuth/Desktop/portfolio/src/assets/logo.png';
const Navbar = () => {
    ...
    <nav className="sticky top-0 z-50 bg-white shadow-md">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          {/* <div className="text-2xl font-bold text-navy-blue">Gopi Raju Rajolu</div> */}
          {/* Logo Section */}
            ...
            <a href="#home" className="flex items-center">
              <img 
                ...
                onError={(e) => {
                  ...
                  e.target.src = "/assets/logo-fallback.png"; // Fallback image if needed
                }}
              />
            </a>
          </div>
          ...
          <div className="md:hidden">
            <button onClick={() => setIsOpen(!isOpen)} className="text-navy-blue focus:outline-none">
